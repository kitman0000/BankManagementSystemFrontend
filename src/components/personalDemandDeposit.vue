	...
	<div>
		<el-form label-width="100px" style="margin-top: 20px;">
			...
			<el-form-item label="金额:">
				...
				<span style="display: inline-block;margin-left: 20px;">个人业务活期利率:{{depositRate}}%</span>
			</el-form-item>
		...
		<el-button @click='submit()' type="primary" icon="el-icon-check" style="border: 0px;position: relative; left:120px">确认活期存款</el-button>
	</div>
</template>
	...
	export default {
		...
		methods: {
			...
			submit(){
				...
				axios.post('/api/personalDemand/deposit', parmas, {
						headers: {
							"token": localStorage.getItem("token"),
						}
					})
					.then(res => {
						if(res.data == "DEMAND_DEPOSIT_SUCCESS"){
							this.$alert('活期存款成功', '提示', {
